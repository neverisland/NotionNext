...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://puddle-calendula-5b3.notion.so/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '02ab3b8678004aa69e9e415905ef32a5,en:7c1d570661754c8fbc568e00a01fd70e',
  AVATAR: '/my-avatar.png', // 个人头像 默认取public目录下的avatar.png
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '杨依', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '互联网世界的探险家，热衷于发现并分享一切新奇有趣的事情.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-weld-iota.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '杨依の博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/my-favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
